<template>
  <nav class="fixed bottom-0 left-0 right-0 z-50 bg-brand-dark border-t border-white/10">
    <div class="mx-auto max-w-[480px] px-4 h-16 flex items-center justify-around">
      <NuxtLink
        to="/"
