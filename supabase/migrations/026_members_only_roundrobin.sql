-- ============================================================
-- 026 — Solo los MIEMBROS reciben asignaciones automáticas
-- ============================================================
-- Los conductores no miembros pueden publicar ofertas de Última
-- Hora (y reciben las reservas de SUS ofertas), pero quedan fuera
-- del reparto round-robin de reservas normales.
-- La exclusividad por parada (024) se respeta tal cual: si el admin
-- elige a un no-miembro como exclusivo, se le asigna igualmente.
-- ============================================================
...
BEGIN
  ...
  -- 1. Exclusividad por parada (decisión del admin, miembro o no)
  ...
  -- 2. Round-robin: SOLO miembros del club
  RETURN QUERY
